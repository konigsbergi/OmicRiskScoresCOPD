...
This Rmd contains code to apply proteomic risk score models to MESA participants (n = XXX). 
...
file = "January/Results/models_copdgene/model_protein_FEV1_post_P2.rds"
  ...
  summary(test2)$coefficients["test$score", "Pr(>|t|)"] #3.518191e-06
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
...
file = "January/Results/models_copdgene/model_protein_FVC_post_P2.rds"
  ...
  summary(test2)$coefficients["test$score", "Pr(>|t|)"] #2.300829e-07
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
...
file = "January/Results/models_copdgene/model_protein_FEV1_FVC_post_P2.rds"
  ...
  summary(test2)$coefficients["test$score", "Pr(>|t|)"] #0.01266752
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
...
file = "January/Results/models_copdgene/model_protein_finalGold_P2.rds"
  ...
  summary(test2)$coefficients["test$score", "Pr(>|t|)"] #0.09785782
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
...
#copd_p2
  ...
  summary(test2)$coefficients["test$score", "Pr(>|z|)"] #0.02294573
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
...
#wa_pct.
file = "January/Results/models_copdgene/model_protein_WallAreaPct_seg_Thirona_P2.rds"
  mod = readRDS(file)
  test = model_select(mod)
  test = replicate(prot_five, mod$modlist[[test[1]]], lambda = test[2]) #
  test = merge(test, pd, by.x = "row.names", by.y = "sidno")
  ...
  summary(test2)[[4]][2,4]   #0.001236539
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
...
file = "January/Results/models_copdgene/model_protein_FEF2575_post_P2.rds"
  ...
  summary(test2)[[4]][2,4] #0.0009894681
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
...
file = "January/Results/models_copdgene/model_protein_PEF_post_P2.rds"
  ...
  summary(test2)[[4]][2,4] #3.774477e-05
  test = test %>% dplyr::select(Row.names, score)
  file = gsub("January/Results/models_copdgene/", "", file)
  file = gsub(".rds", "", file)
  names(test)[2] = file
