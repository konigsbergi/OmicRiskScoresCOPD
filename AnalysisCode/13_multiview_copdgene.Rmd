...
knitr::opts_knit$set(root.dir = 'C:/Users/konigsbi/Desktop/ors_topmed/January/Results/multiview/')
...
setwd("C:/Users/konigsbi/Desktop/ors_topmed/January/Results/multiview/")
files = dir()

#do i use the right pred approach?

files = files[grep("predictions", files)]
files = files[-grep("std", files)]
...
num_vars = c("AWT_seg_Thirona_P2", "distwalked_P2",  
             "FEV1_post_P2", "lung_density_vnb_P2")
...
#fix covar adjs. 
adjust_null = c("distwalked_P2")
adjust_spiro = c("FEV1_post_P2")
...
rho1$bh = NA
rho1$sig = NA
rho1$class = c("gaussian", "gaussian", "gaussian", "gaussian", "log")
...
write.csv(full, "C:/Users/konigsbi/Desktop/ors_topmed/manuscript/Supplement/Full_multi_forSupp.csv")
...
met = readRDS("C:/Users/konigsbi/Desktop/ors_topmed/January/Results/models_copdgene/model_metabolite_lung_density_vnb_P2.rds")
prot = readRDS("C:/Users/konigsbi/Desktop/ors_topmed/January/Results/models_copdgene/model_protein_lung_density_vnb_P2.rds")
rna = readRDS("C:/Users/konigsbi/Desktop/ors_topmed/January/Results/models_copdgene/model_transcript_lung_density_vnb_P2.rds")
comb = readRDS("C:/Users/konigsbi/Desktop/ors_topmed/January/Results/multiview/rho_1_model_lung_density_vnb_P2.rds")
...
e = ggplot(comb, aes(abs(s1), reorder(name, abs(s1)))) + 
...
f = ggplot(met, aes(abs(s1), reorder(name, abs(s1)))) + 
...
png("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/Figure5.png", units = "in", res = 500, width = 10, height = 12)
cowplot::plot_grid(one, four, nrow = 2, rel_heights = c(.3, 1))
dev.off()
...
summary(aov(beta ~ type, full)) #1.96e-05 ***
t.test(beta ~ type, full[full$type == "Combined" | full$type == "Metabolite", ]) #0.002118
t.test(beta ~ type, full[full$type == "Combined" | full$type == "Protein", ]) #0.04066
t.test(beta ~ type, full[full$type == "Combined" | full$type == "Transcript", ]) #0.0001172
t.test(beta ~ type, full[full$type == "Protein" | full$type == "Metabolite", ]) #0.0584
t.test(beta ~ type, full[full$type == "Protein" | full$type == "Transcript", ]) #0.001529
t.test(beta ~ type, full[full$type == "Transcript" | full$type == "Metabolite", ]) #0.04657


summary(aov(-log10(p) ~ type, full)) #0.00154 **
