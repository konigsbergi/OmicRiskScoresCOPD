...
```{r}
#formatting
pd = read.csv("Data/COPDGene/pd_main_overlap.csv", row.names = 1)
...
pred_linear = function(var, dat, ome){
  print(var)
  mod = readRDS(paste0("January/Results/models_copdgene/model_", ome, "_", var, ".rds"))
  ...
  saveRDS(pred_df, paste0("January/Results/predictions_copdgene/predictions_", ome, "_elastic_", var, ".rds"))
}
