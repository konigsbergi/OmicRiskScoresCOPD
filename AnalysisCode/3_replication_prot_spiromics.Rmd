...
This Rmd contains code to apply proteomic risk score models to SPIROMICS participants (n = XXX). 
...
ct = ct[ct$ANALYSIS_STATUS == "Passed", ] #still a fair number of double scans
...
```{r}
#FEV1_P2 --> OBS_FEV1
file = "January/Results/models_copdgene/model_protein_FEV1_post_P2.rds"
mod = readRDS(file)
...
summary(test2)$coefficients["test$score", "Pr(>|t|)"]  #1.032814e-220
...
file = "January/Results/models_copdgene/model_protein_FVC_post_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "January/Results/models_copdgene/model_protein_FEV1_FVC_post_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
summary(test2)$coefficients["test$score", "Pr(>|t|)"]  #1.590482e-213
test = test %>% dplyr::select(Row.names, score)
file = gsub("January/Results/models_copdgene/model_", "", file)
file = gsub(".rds", "", file)
names(test)[2] = file
...
file = "January/Results/models_copdgene/model_protein_finalGold_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
summary(test2)$coefficients["test$score", "Pr(>|t|)"]  #2.407994e-190
test = test %>% dplyr::select(Row.names, score)
file = gsub("January/Results/models_copdgene/model_", "", file)
file = gsub(".rds", "", file)
names(test)[2] = file
...
#chronic brochnits 
file = "January/Results/models_copdgene/model_protein_Chronic_Bronchitis_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
summary(test2)$coefficients["test$score", "Pr(>|z|)"]  #1.044739e-13
test = test %>% dplyr::select(Row.names, score)
file = gsub("January/Results/models_copdgene/model_", "", file)
file = gsub(".rds", "", file)
names(test)[2] = file
...
#copd
file = "January/Results/models_copdgene/model_protein_copd_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
summary(test2)$coefficients["test$score", "Pr(>|z|)"]  #1.599327e-54
test = test %>% dplyr::select(Row.names, score)
file = gsub("January/Results/models_copdgene/model_", "", file)
file = gsub(".rds", "", file)
names(test)[2] = file
...
#POST_FEF2575_DERV
file = "January/Results/models_copdgene/model_protein_FEF2575_post_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
#PEF -> POST_PEFR_DERV
file = "January/Results/models_copdgene/model_protein_PEF_post_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "January/Results/models_copdgene/model_protein_distwalked_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "January/Results/models_copdgene/model_protein_pctEmph_Thirona_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "January/Results/models_copdgene/model_protein_Resting_SaO2_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "January/Results/models_copdgene/model_protein_TLC_Thirona_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "January/Results/models_copdgene/model_protein_lung_density_vnb_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "January/Results/models_copdgene/model_protein_Pi10_Thirona_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
#NEGBINOM traits
#BODE
file = "January/Results/models_copdgene/model_protein_BODE_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
summary(test2)$coefficients["test$score", "Pr(>|z|)"]  #1.109699e-122
test = test %>% dplyr::select(Row.names, score)
file = gsub("January/Results/models_copdgene/model_", "", file)
file = gsub(".rds", "", file)
names(test)[2] = file
...
#SGRQ
file = "January/Results/models_copdgene/model_protein_SGRQ_scoreTotal_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(prot, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
summary(test2)$coefficients["test$score", "Pr(>|z|)"]  #4.996414e-106
test = test %>% dplyr::select(Row.names, score)
file = gsub("January/Results/models_copdgene/model_", "", file)
file = gsub(".rds", "", file)
names(test)[2] = file
