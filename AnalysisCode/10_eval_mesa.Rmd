...
knitr::opts_knit$set(root.dir = "C:/Users/konigsbi/Desktop/ors_topmed/January/Results/predictions_mesa/")
...
setwd("C:/Users/konigsbi/Desktop/ors_topmed/January/Results/predictions_mesa/")
files = dir()
...
dir = "C:/Users/konigsbi/Desktop/ors_topmed/January/Results/predictions_mesa/"
files = dir(dir)
files = files[grep("Exam5", files)]
files = gsub("pctEmph_Thirona_P2_prediction_Exam5omics", "pctEmph_Thirona_P2_prediction_Exam1omics", files)
files = paste0(dir, files)

#can prolly improve this
x = files[1]
comb = data.frame()
for (x in files){
  cur = readRDS(x)
...
#miss = apply(comb, 1, function(x){sum(is.na(x))})
#comb = comb[miss < 25, ] #
...
#delong test
roc.test(auc(comb[rownames(comb) %in% names(pred1), ]$cpgoldab5, pred1), auc(comb[rownames(comb) %in% names(pred2), ]$cpgoldab5, pred2))$p.value #0.77
...
#delong test
roc.test(auc(comb[rownames(comb) %in% names(pred1), ]$cpgoldab5, pred1), auc(comb[rownames(comb) %in% names(pred2), ]$cpgoldab5, pred2))$p.value #2.488385e-15
...
write.csv(df, "C:/Users/konigsbi/Desktop/ors_topmed/manuscript/Supplement/Full_MESA_forSupp.csv")
...
a_one = ggplot(df, aes(beta, -log10(bh), color = type)) + 
  ...
  guides(fill = "none")
#a_one
#ggsave("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/mesa_scorevolcs_multi.png", units = "in", height = 6, width = 12)
...
#ggsave("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/mesa_scorevolcs_single.png", units = "in", height = 6, width = 8)
...
#ggsave("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/MESA_betas.png", units = "in", height = 6, width = 6)
...
#ggsave("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/MESA_oddsratios.png", units = "in", height = 2, width = 7)
...
#  guides(alpha = "none") +
#  xlim(0, 1)
#ggsave("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/MESA_rsqs.png", units = "in", height = 6, width = 7)
...
#ggsave("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/MESA_aucs.png", units = "in", height = 6, width = 7)
...
png("C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/mesa_replication_draft.png", units = "in", res = 500, height = 9, width = 12)
...
save(a_one, a, b, c, d, file = "C:/Users/konigsbi/Desktop/ors_topmed/April/Figures/mesa_rep.Rdata")
