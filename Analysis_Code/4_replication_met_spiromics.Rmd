...
This Rmd contains code to apply metabolomic risk score models to SPIROMICS participants. 
...
#chronic brochnits 
file = "March/Results/models_copdgene/model_metabolite_Chronic_Bronchitis_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "March/Results/models_copdgene/model_metabolite_distwalked_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
#sao2 -> SMW04A_V1
file = "March/Results/models_copdgene/model_metabolite_Resting_SaO2_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "March/Results/models_copdgene/model_metabolite_TLC_Thirona_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
file = "March/Results/models_copdgene/model_metabolite_lung_density_vnb_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
#pi10. there are multiple pi10 measurements. WHOLE_TREE_ALL is for all segments. 
file = "March/Results/models_copdgene/model_metabolite_Pi10_Thirona_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
#NEGBINOM traits
#BODE
file = "March/Results/models_copdgene/model_metabolite_BODE_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
...
#SGRQ
file = "March/Results/models_copdgene/model_metabolite_SGRQ_scoreTotal_P2.rds"
mod = readRDS(file)
test = model_select(mod)
test = replicate(met, mod$modlist[[test[1]]], lambda = test[2]) #
test = merge(test, pd, by.x = "row.names", by.y = "LAD4")
